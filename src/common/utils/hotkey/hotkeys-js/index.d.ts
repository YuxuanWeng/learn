import { KeyHandler, HotkeysEvent } from '@fepkg/common/utils/hotkey/types';
...
type ICodeToKeyCodeMap = { [k in string]: number };
export const codeToKeyCodeMap: ICodeToKeyCodeMap;
export const getKeyCode: (evt: KeyboardEvent) => number;
